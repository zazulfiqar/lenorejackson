                ...
                <table class="table table-bordered" id="user-dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('vendor-deactivate',$user->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Approve" data-placement="bottom"><i class="fas fa-ban"></i></a>
