...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('subcategory.update',$category->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')

        <div class="form-group {{(($category->cat_id==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        {{-- {{$category}} --}}
          ...
          <div class="form-group">
              ...
              <input class="form-control" type="hidden" name="old_file" value="{{$category->photo}}" >
