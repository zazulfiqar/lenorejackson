    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            @if(Auth::user()->role=='admin')
                @if(count($features)>0)
                    <a href="{{route('partfeature.edit',$id)}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Fatures"><i class="fas fa-plus"></i> Edit Features</a>
                @else
