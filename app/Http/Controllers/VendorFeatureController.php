...
use App\Feature;
use App\Http\Requests\VendorFeatureStoreRequest;
use App\Http\Requests\VendorFeatureUpdateRequest;
...
class VendorFeatureController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return  view('backend.feature.create',compact('id'),["features" => $featureDetails]) ;
    }

    public function store(VendorFeatureStoreRequest $request)
    {
...
//            'model' => $request->model,
        ...
        return redirect()->route('vendorfeature.show',$product_id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(VendorFeatureUpdateRequest $request, Feature $feature)
    {
        if ($request->has('front_ac_status')) {
            $front_ac_status = 1;
        }
